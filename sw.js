const NAMA_CACHE = 'aura-turbo-v1';
...
// 2. AKTIVASI: Otomatis menghapus cache lama jika melakukan update aplikasi
...
self.addEventListener('fetch', (event) => {
    ...
    // 🔥 PENGAMAN MUTLAK: Jangan pernah menyimpan (cache) data dari Firebase atau Google Script! 
