document.addEventListener("DOMContentLoaded", function() {
    ...
    let sisaKuotaTerakhir = "Menghitung..."; // Memori kuota
    let persenKuotaTerakhir = 0; // Memori persentase kuota
        ...
        fetch(url)
            ...
            .then(res => {
                if (res.status === 'success') {
                    ...
                    // Simpan data kuota ke memori lokal browser
                    if (res.quota) {
